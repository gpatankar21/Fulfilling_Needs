            ...
            <div class="container">
                <div class="signup-content">
                    <form action="UserDonation" method="POST" id="signup-form" class="signup-form" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <h4>About Us:</h4>
                        <%out.print(org.getInfo());%> <br><br>
                        <b>Contact Number: </b><%out.print(org.getContact_no());%><br>
                        <b>Email: </b><%out.print(org.getEmail());%><br>
                        <b>Address: </b><%out.print(org.getAddress());%><br><br><br></h1> 
